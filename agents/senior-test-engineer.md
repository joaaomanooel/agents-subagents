...
description: >-
  Use this agent to design, write, review, or audit tests across the full stack
  — unit, integration, component, API, and end-to-end. Acts as a quality
  gatekeeper: rejects weak tests, false positives, implementation-coupled
  assertions, and empty coverage. Works with any testing library and any
  language. Examples: writing tests for a new feature, auditing an existing
  test suite for false confidence, setting up an E2E harness, reviewing PR test
  coverage, fixing flaky tests, or establishing testing conventions for a new
  project.
mode: all
---
task_agents: []
